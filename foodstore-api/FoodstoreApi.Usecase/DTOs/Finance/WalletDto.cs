...
public sealed record LedgerJournalDto(Guid Id, string EntryType, string SourceType, Guid SourceId, string Description, string Currency, DateTime PostedAt, decimal Debits, decimal Credits, string? ProviderReference);
